import delimited "C:\Users\robin\OneDrive\Desktop\EC331 code\EC331 submission\End code\Rcode\dataentropyforimports.csv", colrange(2) numericcols(8 9) clear

encode country, generate(panel_id)
xtset panel_id year
gen treatment=0
gen lpop=log(workagepop)
eststo sumstats: quietly estpost sum entropy educbasic rd fdiinflows, detail
...
*graph export "C:\Users\robin\OneDrive\Desktop\EC331 code\Graphs\Entropy imports.pdf", as(pdf) name("Graph")

xtreg entropy lpop fdiinflows rd treatment, fe
...
xtdidregress(entropy lpop fdiinflows rd)(treatment), group(eu_2004) time(year)
